...
use AP50\Controllers\MainController;
use AP50\Core\Interfaces\IRequest;
use AP50\Core\Interfaces\IRoute;
...
class Dispatcher
{
    ...
    private function dispatch()
    {
        ...
        if (isset($this->routeList[$this->currentRequest->getRoute()])) {
            //Aqui dentro tenetemos un texto del tipo AP50\Controller\DetalleController
            $controllerClass = "AP50\\Controllers\\" . $this->routeList[$this->currentRequest->getRoute()]["controller"];
            //Es equivalente a $controller = new AP50\Controller\MainController o DetalleController;
