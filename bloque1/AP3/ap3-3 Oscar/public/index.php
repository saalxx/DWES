...
// crear dos controller tal y como se llaman en controller de rutas.json y crear las funciones que llaman en los controller con action en el json ***** el default esta para mirarlo porque no esta utilizado